...
def validate_user_registration_request_data(data: Dict[str, str]) -> Union[Dict[str, str], dict, str]:
...
def validate_resend_email_request_data(data: Dict[str, str]) -> Union[Dict[str, str], dict]:
    # Verify if request body has required fields
    if "email" not in data:
        return messages.EMAIL_FIELD_IS_MISSING
...
def validate_update_profile_request_data(data: Dict[str, str]) -> Union[Dict[str, str], dict, str]:
...
def validate_new_password(data: Dict[str, str]) -> Union[Dict[str, str], dict, str]:
